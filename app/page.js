...
<div style={{marginTop:20}}>
  <div style={card}>
    ...
    <button onClick={()=>runPortfolio(portfolioGroup)} disabled={portfolioLoading} style={{width:"100%",padding:"18px",borderRadius:14,border:"none",background:portfolioLoading?C.g200:"linear-gradient(135deg,#059669,#10b981)",color:"#fff",fontSize:14,fontWeight:700,fontFamily:"inherit",cursor:portfolioLoading?"not-allowed":"pointer",boxShadow:"0 2px 8px rgba(0,0,0,.12)"}}>
