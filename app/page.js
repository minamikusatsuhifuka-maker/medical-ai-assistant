...
- コンパクトに詰めて記載`},
{id:"soap-lite",name:"📋 簡易",prompt:`皮膚科の医療秘書として超簡潔に要約。話者分離：丁寧語・指示語は医師、訴え・希望は患者。
...
{[
{icon:"📋",name:"ASOP",desc:"標準カルテ形式。S)主訴 O)所見 P)計画 に自動分類。複数疾患は自動で分離"},
{icon:"📋",name:"簡易ASOP",desc:"超簡潔版。1疾患3行以内。薬剤名と用法のみのシンプルなカルテ要約"},
