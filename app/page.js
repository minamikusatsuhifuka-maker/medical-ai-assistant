...
{isTrans&&<button onClick={()=>setFavDetailModal({...f,title:"📝 書き起こし"})} title="書き起こし内容を表示" onMouseEnter={e=>showTip(e,"書き起こし内容を表示")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:"1px solid rgba(160,220,100,0.3)",background:"rgba(220,252,231,0.5)",fontSize:11,fontWeight:600,color:"#166534",fontFamily:"inherit",cursor:"pointer"}}>📝書起</button>}
{isSum&&<button onClick={()=>setFavDetailModal({...f,title:"📋 要約"})} title="要約内容を表示" onMouseEnter={e=>showTip(e,"要約内容を表示")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:"1px solid rgba(160,220,100,0.4)",background:"rgba(220,252,231,0.6)",fontSize:11,fontWeight:600,color:"#166534",fontFamily:"inherit",cursor:"pointer"}}>📋要約</button>}
{!isTrans&&!isSum&&<button onClick={()=>setFavDetailModal(f)} title="内容を表示" onMouseEnter={e=>showTip(e,"内容を表示")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:`1px solid ${C.g200}`,background:C.g50,fontSize:11,fontWeight:600,color:"#2a4a18",fontFamily:"inherit",cursor:"pointer"}}>📋内容</button>}
<button onClick={()=>openEditModal(f)} title="タイトル・内容を編集" onMouseEnter={e=>showTip(e,"タイトル・内容を編集")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:"1px solid #f59e0b",background:"#fffbeb",fontSize:11,fontWeight:600,color:"#92400e",fontFamily:"inherit",cursor:"pointer"}}>⭐</button>
...
<button onClick={()=>openGenModal(f)} title="この内容から資料を生成" onMouseEnter={e=>showTip(e,"この内容から資料を生成")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:"1px solid #93c5fd",background:"#eff6ff",fontSize:11,fontWeight:600,color:"#2563eb",fontFamily:"inherit",cursor:"pointer"}}>📄資料生成</button>
<button onClick={()=>setFavMoveModal(f)} title="別グループへ移動" onMouseEnter={e=>showTip(e,"別グループへ移動")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:`1px solid ${C.g200}`,background:C.g50,fontSize:11,fontWeight:600,color:"#2a4a18",fontFamily:"inherit",cursor:"pointer"}}>📁移動</button>
<button onClick={()=>deleteFavorite(f.id)} title="お気に入りから削除" onMouseEnter={e=>showTip(e,"お気に入りから削除")} onMouseLeave={hideTip} style={{padding:"4px 12px",borderRadius:6,border:"1px solid #fca5a5",background:"#fef2f2",fontSize:11,fontWeight:600,color:"#ef4444",fontFamily:"inherit",cursor:"pointer"}}>🗑️</button>
</div></div>})}
</div>}
{/* お気に入り全文モーダル */}
