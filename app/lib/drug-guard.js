...
5. 会話に出た薬剤は、処方の有無にかかわらず全てP)に残し、それぞれ以下のいずれかの状態を必ず併記する。
   - 新規: 今回はじめて処方する
   - 継続: 前回からの処方を続ける
   - 中止: 今回でやめる、または使用をやめるよう指示した
   - 残薬あり: 手元に残っているため今回は処方しない
   - (状態不明): 会話から上記のいずれとも判断できない
   状態が判断できないことを理由に、その薬剤をP)から省略してはならない。必ず「(状態不明)」と書いて残す。

   記載例:
   P)ベピオウォッシュゲル5%(継続)、ゼビアックスローション2%(新規)、ディフェリンゲル0.1%(残薬あり)

   ※第5条は会話に登場した薬剤の取りこぼしを防ぐ規定である。
     第3条の「書き起こしにない薬剤名を補ってはならない」を上書きするものではない。`;
